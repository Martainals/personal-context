...
- The only normal inbox delivery is `<audio-stem>-录音转写.md`. It contains the complete transcript and is sensitive personal data. The invisible generated marker stores hashes and counts, not a second copy of transcript text.
